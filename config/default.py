...
_C.DATA_AUG = CfgNode()
_C.DATA_AUG.RANDOM_RESIZE_CROP = CfgNode()
_C.DATA_AUG.RANDOM_RESIZE_CROP.USE = True
_C.DATA_AUG.RANDOM_RESIZE_CROP.SCALE = [0.9, 1.1]
_C.DATA_AUG.RANDOM_RESIZE_CROP.RATIO = [0.9, 1.1]
_C.DATA_AUG.RANDOM_RESIZE_CROP.PROBABILITY = 0.6
_C.DATA_AUG.RANDOM_BRIGHTNESS_CONTRAST = CfgNode()
_C.DATA_AUG.RANDOM_BRIGHTNESS_CONTRAST.USE = True
_C.DATA_AUG.RANDOM_BRIGHTNESS_CONTRAST.BRIGHTNESS_CHANGE = 0.2
_C.DATA_AUG.RANDOM_BRIGHTNESS_CONTRAST.CONTRAST_CHANGE = 0.1
_C.DATA_AUG.RANDOM_BRIGHTNESS_CONTRAST.PROBABILITY = 0.6
